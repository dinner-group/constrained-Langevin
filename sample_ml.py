...
q1, p1, l1, energy, force, _, args = lgvn.rattle_kick(q0, p0, dt / 2, U, f, J, args=args, linsol=linear_solver.qr_lstsq_rattle_bvp)
n_steps = 1000000
thin = 100
out = []
key_out = []
...
while n_steps > 0:
    ...
    q1, p1, l1, energy, force, _, args = lgvn.rattle_kick(q1, p1, dt / 2, U, f, J, args=(mesh_points, bounds), linsol=linear_solver.qr_lstsq_rattle_bvp)
