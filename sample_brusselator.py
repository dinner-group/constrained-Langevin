...
#
#    traj_br_lc, key_lc = lgvn.gBAOAB(q1, p1, l1, dt, friction, n_mesh_recompute, thin, prng_key, br_lc_U, br_lc_f, br_lc_J, energy=energy, force=force, nlsol=nonlinear_solver.newton_bvp_dense, max_newton_iter=20, tol=1e-8)
#
...
#
#    traj_br_lc, key_lc = lgvn.gBAOAB(q1, p1, l1, dt, friction, n_steps, thin, prng_key, br_lc_U, br_lc_f, br_lc_J, energy=energy, force=force, nlsol=nonlinear_solver.newton_bvp_dense, max_newton_iter=20, tol=1e-8)
...
traj_br_lc, key_lc = lgvn.gBAOAB(q1, p1, l1, dt, friction, n_steps, thin, prng_key, br_lc_U, br_lc_f, br_lc_J, energy=energy, force=force, A=rattle_drift_brusselator_bvp_mm, 
                                 nlsol=nonlinear_solver.quasi_newton_bvp_dense, max_newton_iter=50, tol=1e-8, args=args)
